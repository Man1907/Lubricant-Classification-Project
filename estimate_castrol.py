"""
Castrol 10W-30 — ASTM Color Estimator
=======================================
Auto-detects oil cup via circle detection.
Compares oil color against pre-measured ASTM chip Lab values.
Fresh baseline: ASTM 1.0

Usage:
  python estimate_castrol.py image1.jpg [image2.jpg ...]
  python estimate_castrol.py --csv results.csv image1.jpg ...
"""
...
OIL_NAME = "Castrol 10W-30"
FRESH_ASTM = 1.0
CALIBRATION_OFFSET = 0.5  # raw 1.5 - true 1.0
